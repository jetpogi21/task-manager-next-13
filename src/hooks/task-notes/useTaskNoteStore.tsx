...
import { DEFAULT_SORT_BY } from "@/utils/constants/TaskNoteConstants";
...
type State = {
  ...
  currentData: TaskNoteFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: TaskNoteFormikShape[]) => void;
...
const useTaskNoteStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
