...
import { TagDeletePayload } from "@/interfaces/TagInterfaces";
...
type State = {
  ...
  mutate?: (payload: TagDeletePayload) => void;
  setMutate: (mutate: (payload: TagDeletePayload) => void) => void;
};

// Create your store, which includes both state and (optionally) actions
const useTagDeleteDialog = create<State>((set) => ({
  recordsToDelete: [],
