...
import { GetTagsResponse, TagFormikShape } from "@/interfaces/TagInterfaces";
...
type State = {
  queryResponse?: () => UseInfiniteQueryResult<GetTagsResponse, unknown>;
  recordCount: number;
  page: number;
  lastFetchedPage: number;
  fetchCount: boolean;
  rowSelection: RowSelectionState;
  currentData: TagFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
...
type Actions = {
  ...
  setCurrentData: (item: TagFormikShape[]) => void;
...
const useTagStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 1,
  lastFetchedPage: 1,
  fetchCount: true,
