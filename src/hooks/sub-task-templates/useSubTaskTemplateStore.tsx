...
import { DEFAULT_SORT_BY } from "@/utils/constants/SubTaskTemplateConstants";
...
type State = {
  ...
  currentData: SubTaskTemplateFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: SubTaskTemplateFormikShape[]) => void;
...
const useSubTaskTemplateStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
...
export { useSubTaskTemplateStore };
