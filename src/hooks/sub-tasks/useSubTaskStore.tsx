...
import { DEFAULT_SORT_BY } from "@/utils/constants/SubTaskConstants";
...
type State = {
  ...
  currentData: SubTaskFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: SubTaskFormikShape[]) => void;
...
const useSubTaskStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
