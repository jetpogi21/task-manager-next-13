...
const TaskIntervalSchema = Yup.object().shape({
  //Generated by GetAllFieldValidationBySeqModel
  name: Yup.string().required("Name is a required field."),
});

const TaskIntervalArraySchema = Yup.object().shape({
  TaskIntervals: Yup.array().of(
    Yup.object().shape({
...
export { TaskIntervalSchema, TaskIntervalArraySchema };
