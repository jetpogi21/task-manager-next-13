...
export interface TaskCategoryUpdatePayload
  extends Partial<TaskUpdatePayload>,
    Partial<TaskTemplateUpdatePayload> {
...
export interface TaskCategoryFormUpdatePayload
  extends Omit<TaskCategoryFormikShape, "touched" | "index">, //Generated by GetModelUpdatePayload - ModelUpdatePayload
