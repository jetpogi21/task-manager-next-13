...
import { DEFAULT_FILTERS,CONTROL_OPTIONS, } from "@/utils/constants/TaskIntervalConstants";
...
const TaskIntervalFilterForm: React.FC = () => {
  ...
  //Zustand stores
  const [setPage, setLastPage, setFetchCount, resetRowSelection, setCursor] = useTaskIntervalStore(
    (state) => [
      state.setPage,
      state.setLastPage,
      state.setFetchCount,
  ...
  const handleFormikSubmit = (
    ...
    const params = {
      ...query,
      ...(getParamsObject(values, defaultFilters) as Partial<TaskIntervalSearchParams>),
    };
