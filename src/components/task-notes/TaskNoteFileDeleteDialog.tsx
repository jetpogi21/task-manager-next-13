//Generated by WriteToModelfiledeletedialog_tsx - ModelFileDeleteDialog.tsx
"use client";
...
interface TaskNoteFileDeleteDialogProps {
  onSuccess?: () => void;
  formik?: any;
}

export function TaskNoteFileDeleteDialog(props: TaskNoteFileDeleteDialogProps) {
  ...
  const [
    ...
    setRecordsToDelete,
    setIsDialogLoading,
  ] = useTaskNoteFileDeleteDialog((state) => [
