...
export function TaskCategoryMultiCreateDeleteDialog() {
  ...
  const [currentData, resetRowSelection, setCurrentData] = useTaskCategoryStore(
    (state) => [
      state.currentData,
  ...
  const mutateTaskCategory = () => {
    mutate && mutate({ deletedTaskCategories: recordsToDelete });
  };
