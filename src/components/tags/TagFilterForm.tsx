...
import { DEFAULT_FILTERS,CONTROL_OPTIONS, } from "@/utils/constants/TagConstants";
...
const TagFilterForm: React.FC = () => {
  ...
  //Zustand stores
  const [setPage, setLastPage, setFetchCount, resetRowSelection, setCursor] = useTagStore(
    (state) => [
      state.setPage,
      state.setLastPage,
      state.setFetchCount,
