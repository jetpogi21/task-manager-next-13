...
const findOptions: FindOptions<typeof Task> = {
  ...
  include: [
    ...
    },
    {
      ...
      attributes: ["id", "note", "taskID", "file", "fileSize", "fileName"],
    },
  ],
  //Generated by GenerateAttributesOption
...
export const PUT = async (
  ...
  //Generated by GetAllRelatedDropzoneModel
  const {
    TaskNoteFiles, //Generated by GetRelatedDropzoneModel - GetRelatedDropzoneModel
  } = res;
  ...
  try {
    ...
    //Generated by GetAllRelatedDropzoneModelUpdateOrInsert
    //Generated by GetRelatedDropzoneModelUpdateOrInsert - GetRelatedDropzoneModelUpdateOrInsert

    if (TaskNoteFiles) {
      for (const item of TaskNoteFiles) {
        item.taskID = id;
        await TaskNoteSchema.validate(item);
