...
import { ColumnAttrs } from "@/interfaces/GeneralInterfaces";
...
export const COLUMNS: Record<string, ColumnAttrs> = {
  ...
  taskTemplateID: {
    type: "number",
    db_name: "task_template_id",
    verboseFieldName: "Task Template ID",
    sortOrder: 0,
    verboseSortFieldName: "",
  }, //Generated by GetConstantFieldDictionary - Constant Field Dictionary
  date: {
    type: "string",
    db_name: "date",
