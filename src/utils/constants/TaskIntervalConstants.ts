...
import { TaskIntervalFormikFilter } from "@/interfaces/TaskIntervalInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "TaskInterval";
export const TABLE_NAME = "taskmanager_taskinterval";
export const PLURALIZED_MODEL_NAME = "TaskIntervals";
export const VERBOSE_MODEL_NAME = "Task Interval";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Task Intervals";
export const DEFAULT_SORT_BY = "name";
export const VARIABLE_PLURAL_NAME = "taskIntervals";
export const MODEL_PATH = "task-intervals";
export const DEFAULT_FILTERS: Partial<TaskIntervalFormikFilter> = {
