...
import { TaskCategoryFormikFilter } from "@/interfaces/TaskCategoryInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "TaskCategory";
export const TABLE_NAME = "taskmanager_taskcategory";
export const PLURALIZED_MODEL_NAME = "TaskCategories";
export const VERBOSE_MODEL_NAME = "Task Category";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Task Categories";
export const DEFAULT_SORT_BY = "name";
export const VARIABLE_PLURAL_NAME = "taskCategories";
export const MODEL_PATH = "task-categories";
export const DEFAULT_FILTERS: Partial<TaskCategoryFormikFilter> = {
